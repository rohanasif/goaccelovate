...
export default function AuthForm({ type = "signin", onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    setError(null);
    await onSubmit(e, setIsLoading, setError);
  };
  ...
  const title = isSignIn ? "Sign in to your account" : "Create your account";
  const submitText = isSignIn ? "Sign in" : "Create account";
  const loadingText = isSignIn ? "Signing in..." : "Creating account...";
  const alternateLink = isSignIn ? "/auth/register" : "/auth/signin";
  const alternateText = isSignIn ? "Register here" : "Sign in here";
  const alternatePrompt = isSignIn
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                } focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed`}
